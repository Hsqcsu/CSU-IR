...
train_smiles_path = r'D:\Spectrum\github\CSU-IR\data\pretrain_data\Molecular dynamics simulation data\USTPO_train_smiles.txt'
train_ir_path = r'D:\Spectrum\github\CSU-IR\data\pretrain_data\Molecular dynamics simulation data\USTPO_train_ir.pt'
val_smiles_path = r'D:\Spectrum\github\CSU-IR\data\pretrain_data\Molecular dynamics simulation data\USTPO_val_smiles.txt'
val_ir_path = r'D:\Spectrum\github\CSU-IR\data\pretrain_data\Molecular dynamics simulation data\USTPO_val_ir.pt'
test_smiles_path = r'D:\Spectrum\github\CSU-IR\data\pretrain_data\Molecular dynamics simulation data\USTPO_test_smiles.txt'
test_ir_path = r'D:\Spectrum\github\CSU-IR\data\pretrain_data\Molecular dynamics simulation data\USTPO_test_ir.pt'
...
print(f"Number of validation sets量: {len(val_dataset)}")
print(f"Number of test sets: {len(test_dataset)}")

device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
SmilesModel.to(device)
IR_model.to(device)
print(f"SmilesModel Parameters: {count_parameters(SmilesModel)}")
