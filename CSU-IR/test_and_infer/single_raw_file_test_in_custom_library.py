...
PRETRAIN_SMILES_MODEL_PATH = os.path.join(PROJECT_ROOT, "check_points", "Multi-stage_training_Stage_III_EXP","MD_DFT_EXP", "best_smiles_model.pth")
PRETRAIN_IR_MODEL_PATH = os.path.join(PROJECT_ROOT, "check_points", "Multi-stage_training_Stage_III_EXP","MD_DFT_EXP", "best_ir_model.pth")
